...
-- ==========================================================
-- DROP TABLE IF EXISTS dgt_ren.atribuir_municipio;
CREATE TABLE IF NOT EXISTS dgt_ren.atribuir_municipio (
...
CREATE TABLE IF NOT EXISTS dgt_ren.tip_l (
    ...
    FOREIGN KEY (dtcc) REFERENCES dgt_ren.atribuir_municipio (dtcc)
        ON DELETE CASCADE 
        ON UPDATE CASCADE
);
...
-- Table: atribuir_municipio
-- ==========================================================
INSERT INTO dgt_ren.atribuir_municipio 
     (dtcc)
 VALUES 
     ('1401');
